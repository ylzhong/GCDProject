...
```{r subset the dataset, cache=TRUE}
...
```{r name the activityes,cache=TRUE}
#step 1
...
## Final part: please use following line to read txt file I submitted through coursera if you want to check the correctness of my submitted file. Also, the readme.Rmd and analysis_R contain the same r code. 
